...
export default function adminRegister() {
  ...
  return (
    <div className="bg-white relative text-gray-900 h-screen overflow-hidden">
      <div className="flex flex-col items-center justify-between pr-10 pb-0 pl-10 mt-8 mr-auto xl:px-5 lg:flex-row ">
        <div className="flex flex-col justify-center items-center w-full pr-10 pl-10 lg:flex-row">
          <div className="w-full mt-10 mr-0 mb-0 ml-0 relative max-w-2xl lg:mt-0 lg:w-5/12">
            <div className="flex flex-col items-center justify-start pt-4 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
